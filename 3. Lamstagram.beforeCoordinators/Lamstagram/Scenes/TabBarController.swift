...
class TabBarController: UITabBarController {
    override func viewDidLoad() {
        ...
        let feedViewController = storyboard.instantiateViewController(identifier: "FeedViewController") { coder -> UIViewController? in
            let viewModel = DIContainer.current.assembler.resolver.resolve(FeedViewModel.self)!
        ...
        let profileViewModel = DIContainer.current.assembler.resolver.resolve(ProfileViewModel.self)!
